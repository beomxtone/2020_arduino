...
// adjust servo position according to the USS read value
  ...
  // add your code here!
int val;
if (dist_ema > 0 && dist_ema < 220) val = map(dist_ema, 180, 220, _DUTY_MIN, _DUTY_NEU);
else if (dist_ema == 220.0) val = _DUTY_NEU;
else val = map(dist_ema, 220, 360, _DUTY_NEU, _DUTY_MAX);

if (dist_ema < 180 || dist_ema > 360) digitalWrite(PIN_LED, 1);
